"""
Django settings for hfhjhjv_412 project.
...
WSGI_APPLICATION = 'hfhjhjv_412.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hfhjhjv_412 API",
    "DESCRIPTION": "API documentation for hfhjhjv_412 App",
    "VERSION": "v1",
}
